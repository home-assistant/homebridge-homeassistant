...
function HomeAssistantSensorFactory(log, data, client) {
  ...
  if (entity.attributes.unit_of_measurement == '°C' || entity.attributes.unit_of_measurement == '°F') {
  ...
  } else if (entity.attributes.unit_of_measurement == "%" && data.entity_id.includes("humidity")) {
    service = Service.HumiditySensor
    characteristic = Characteristic.CurrentRelativeHumidity
  } else if (entity.attributes.unit_of_measurement == "lux") {
