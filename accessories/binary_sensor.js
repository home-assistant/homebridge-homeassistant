...
function HomeAssistantBinarySensorFactory(log, data, client) {
  if (!(entity.attributes && entity.attributes.sensor_class)) {
    return null
  }
  switch(data.attributes.sensor_class) {
    case 'moisture':
      return new HomeAssistantBinarySensor(log, entity, client,
          Service.LeakSensor,
    ...
    case 'occupancy':
      ...
      break
    case 'opening':
      return new HomeAssistantOpening(log, entity, client)
    case 'smoke':
      return new HomeAssistantBinarySensor(log, entity, client,
          Service.SmokeSensor,
